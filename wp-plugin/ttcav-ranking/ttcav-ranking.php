...
class WP_TTCAV_Ranking {
    ...
    public function register_settings() {
        $fields = [ 'TTCAV_DB_Ranking_host', 'TTCAV_DB_Ranking_name', 'TTCAV_DB_Ranking_user', 'TTCAV_DB_Ranking_pass', 'ttcav_club_id', 'ttcav_fftt_id', 'ttcav_fftt_key' ];
        foreach ( $fields as $f ) {
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    <tr><th scope="row">Hôte MySQL</th>
                        <td><input type="text" name="TTCAV_DB_Ranking_host" value="<?php echo esc_attr( get_option( 'TTCAV_DB_Ranking_host', 'localhost' ) ); ?>" class="regular-text"></td></tr>
                    <tr><th scope="row">Base de données</th>
                        <td><input type="text" name="TTCAV_DB_Ranking_name" value="<?php echo esc_attr( get_option( 'TTCAV_DB_Ranking_name', 'fftt_manager' ) ); ?>" class="regular-text"></td></tr>
                    <tr><th scope="row">Utilisateur MySQL</th>
                        <td><input type="text" name="TTCAV_DB_Ranking_user" value="<?php echo esc_attr( get_option( 'TTCAV_DB_Ranking_user', '' ) ); ?>" class="regular-text"></td></tr>
                    <tr><th scope="row">Mot de passe MySQL</th>
                        <td><input type="password" name="TTCAV_DB_Ranking_pass" value="<?php echo esc_attr( get_option( 'TTCAV_DB_Ranking_pass', '' ) ); ?>" class="regular-text"></td></tr>
