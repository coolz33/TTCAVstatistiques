...
<div class="container py-5">
        <header class="text-center mb-5">
            <h1 class="display-4 fw-bold">Les compétiteurs du <?php echo htmlspecialchars($club_name); ?> <small class="club-number">(<?php echo $club_id; ?>)</small></h1>
                                ...
                                <div class="player-avatar avatar-md" data-licence="<?php echo $p['licence']; ?>" 
                                    ...
                                    <?php if (!empty($p['avatar'])): ?>
                                        <div class="avatar-crop-container">
                                            <img src="<?php echo esc_url('https://ttcav2.coolz.fr/assets/avatars/' . $p['avatar']); ?>" 
                                                 alt="" 
                                                 class="avatar-img"
